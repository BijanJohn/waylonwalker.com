...
description: Changing conda environments is a bit verbose, I use a function with fzf
  ...
  Wha
edit_link: https://github.com/edit/main/pages/blog/quickly-change-conda-env-with-fzf.md
jinja: false
long_description: Changing conda environments is a bit verbose, I use a function with
  ...
  using What environment manager do you use for python? Conda environments are stored
  in a central lo
now: 2022-10-29 15:54:38.064661
...
super_description: Changing conda environments is a bit verbose, I use a function
  with fzf that I have used conda as a virtual environment tool for years now.  I
  started using What environment manager do you use for python? Conda environments
  are stored in a central location such as Conda environments are created with the  After
  running this command you will have a directory  Before activating an environment
  I often want to list the environments that I After running this command you will
  see something like the fol
tags:
- python

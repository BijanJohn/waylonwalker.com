...
description: "This is a quickstart to getting a new  \U0001F9F9 Install  \U0001F6E2
  Create the Example Pipeline \U0001F4A8 Run the example \U0001F4C9 Show the pipeline
  visualization I use conda to control my vi"
edit_link: https://github.com/edit/main/pages/blog/create-new-kedro-project.md
jinja: false
long_description: "This is a quickstart to getting a new  \U0001F9F9 Install  \U0001F6E2
  Create the Example Pipeline \U0001F4A8 Run the example \U0001F4C9 Show the pipeline
  visualization I use conda to control my virtual environments and will create a new
  environment called  Options I try to keep my base"
now: 2022-10-29 15:54:38.063447
path: pages/blog/create-new-kedro-project.md
slug: create-new-kedro-project
status: published
super_description: "This is a quickstart to getting a new  \U0001F9F9 Install  \U0001F6E2
  Create the Example Pipeline \U0001F4A8 Run the example \U0001F4C9 Show the pipeline
  visualization I use conda to control my virtual environments and will create a new
  environment called  Options I try to keep my base environment as clean as possible.
  \ I have ran into too many issues installing things in the base environment.  Almost
  always its some dependency that starts causing issues making it even harder to realize
  where its coming from as I never even instal"
tags:
- kedro
- python

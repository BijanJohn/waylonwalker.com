...
description: none
edit_link: https://github.com/edit/main/pages/blog/datacamp-sql.md
jinja: false
long_description: In 2018 I transitioned from a Product Engineering (Mechanical) role
  ...
  in python.  My
now: 2022-10-29 15:54:38.064627
...
super_description: In 2018 I transitioned from a Product Engineering (Mechanical)
  ...
  analysis.    Just run something like the following and you have data. This technique
  works gr
tags:
- data
- sql
...
<div class='prevnext'>
    ...
    <a class='prev' href='/death-by-powerpoint'>
        ...
        <div class='prevnext-text'>
            ...
            <p class='prevnext-title'>No More Death By PowerPoint</p>
        </div>
    </a>

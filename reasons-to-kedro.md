...
description: 'There are many reasons that you should be using kedro.  If you are on
  a team of https://waylonwalker.com/what-is-kedro Kedro makes it super easy to get
  started '
edit_link: https://github.com/edit/main/pages/blog/reasons-to-kedro.md
jinja: false
long_description: There are many reasons that you should be using kedro.  If you are
  on a team of https://waylonwalker.com/what-is-kedro Kedro makes it super easy to
  get started with their cli that utilizes https://waylonwalker.com/create-new-kedro-project
  read more a
now: 2022-10-29 15:54:38.064147
...
super_description: 'There are many reasons that you should be using kedro.  If you
  are on a team of https://waylonwalker.com/what-is-kedro Kedro makes it super easy
  to get started with their cli that utilizes https://waylonwalker.com/create-new-kedro-project
  read more about how to start your first kedro project here Kedro provides many tools
  that help teams collaborate on a single codebase. Kedro makes it easy to collaborate
  with members who aren Share catalog entries with folks doing EDA. For those who
  may not be '
tags:
- kedro
- python
...
<div class="onelinelink-wrapper">
    <a class="onelinelink" href="https://waylonwalker.com/create-new-kedro-project/">
        <img style="float: right;" align='right' src="https://covers.waylonwalker.com/create-new-kedro-project.jpg" alt="article cover for Create New Kedro Project"/>
        <p><strong>Create New Kedro Project</strong></p>
    </a>
</div>
...
<div class="onelinelink-wrapper">
    <a class="onelinelink" href="https://waylonwalker.com/creating-the-kedro-preflight-hook/">
        <img style="float: right;" align='right' src="https://covers.waylonwalker.com/creating-the-kedro-preflight-hook.jpg" alt="article cover for creating the kedro-preflight hook"/>
        <p><strong>creating the kedro-preflight hook</strong></p>
    </a>
</div>

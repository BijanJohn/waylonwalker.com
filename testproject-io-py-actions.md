...
description: As I continue to build out  Running integration tests will not prevent
  bugs from happening completely, but it will allow me to quickly spot them and rollback.
  T
edit_link: https://github.com/edit/main/pages/blog/testproject-io-py-actions.md
jinja: false
long_description: 'As I continue to build out  Running integration tests will not
  prevent bugs from happening completely, but it will allow me to quickly spot them
  and rollback. The very first thing that comes to my mind is anything that is loaded
  or ran client-side.  '
now: 2022-10-29 15:54:38.065111
path: pages/blog/testproject-io-py-actions.md
slug: testproject-io-py-actions
status: published
super_description: As I continue to build out  Running integration tests will not
  prevent bugs from happening completely, but it will allow me to quickly spot them
  and rollback. The very first thing that comes to my mind is anything that is loaded
  or ran client-side.  Two things quickly came to mind here.  I run gatsby so most
  of my content is statically rendered, and it yells at me if something isn things
  I was looking for from features to test client-side interactions external API features
  on my blog to consider
tags:
- python

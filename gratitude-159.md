...
article_html: "<p>Laundry room is working!  It appears that for years the dryer vent
  has been\njust kinda set on top of the hole in the floor, not attached at all.....
  This\nhad blown dryer lint over everything in the laundry room, and I am curious
  if\nit contributed tot he excessive duest on everyting in the whole house.  I got\nit
  all cleaned out and hooked up to the best of my ability.  The connections\nhave
  a solid couple inches overlap and taped tight.</p>\n<p>The one issue that we ran
  into was. I fully setup the washer, then pulled it\nback out, and forgot to put
  the drain back on before running a load and\ndraining in onto the floor.</p>\n<div
  class='prevnext'>\n\n    <style type='text/css'>\n\n    :root {\n      --prevnext-color-text:
...
edit_link: https://github.com/edit/main/pages/gratitude/gratitude-159.md
jinja: false
long_description: Laundry room is working The one issue that we ran into was. I fully
  setup the washer, then pulled it
now: 2022-10-29 15:54:38.062215
path: pages/gratitude/gratitude-159.md
slug: gratitude-159
status: draft
super_description: Laundry room is working The one issue that we ran into was. I fully
  setup the washer, then pulled it
tags: []

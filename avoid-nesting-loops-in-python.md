...
description: Nesting loops inside of each other in python makes for much harder code
  ...
  tha
edit_link: https://github.com/edit/main/pages/blog/avoid-nesting-loops-in-python.md
jinja: false
long_description: Nesting loops inside of each other in python makes for much harder
  ...
  may make sense, b
now: 2022-10-29 15:54:38.065145
...
super_description: 'Nesting loops inside of each other in python makes for much harder
  ...
  the future. Lets take a pretty simple example where we are using a ficticious library
  to get some sales '
tags: []
...
<div class='prevnext'>
    ...
    <a class='prev' href='/awesome-people'>

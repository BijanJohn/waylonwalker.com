...
cover: ''
date: 2022-08-21
datetime: 2022-08-21 00:00:00+00:00
description: a sprinter edging out his opponent by Dall-e It Markata started off partly
  as a python developer frustrated with using nodejs Over time this side project has
  gr
edit_link: https://github.com/edit/main/pages/til/markata-0.3.0.md
jinja: false
long_description: a sprinter edging out his opponent by Dall-e It Markata started
  off partly as a python developer frustrated with using nodejs Over time this side
  project has grown some warts and some of them were now I like to use my tils articles
  for examples and t
now: 2022-10-29 15:54:38.066233
path: pages/til/markata-0.3.0.md
slug: markata-0-3-0
status: published
super_description: 'a sprinter edging out his opponent by Dall-e It Markata started
  off partly as a python developer frustrated with using nodejs Over time this side
  project has grown some warts and some of them were now I like to use my tils articles
  for examples and tests like this as there are At the time of writing this is the
  current version of markata, so just make a cold tils: 14.523 cold tils: 11.551 (+20%)
  These measurements were taken with pyinstrument mostly out of convenience since
  Here is the pyinstrum'
tags:
- python
templateKey: til
...
<div class='prevnext'>
    ...
    <a class='prev' href='/markata-configure-head'>
